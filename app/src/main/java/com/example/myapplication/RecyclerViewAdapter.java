...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    private ArrayList<ParaMessage> list;

    public RecyclerViewAdapter(Context context, ArrayList<ParaMessage> list) {
        this.context = context;
        this.list = list;
    }

    public void addMessage(ParaMessage msg){
        list.add(0,msg);
    ...
    public RecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.message_design,parent,true);
